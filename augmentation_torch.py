...
def preProcessingData(data_dir):
...
if __name__ == "__main__":
    ...
    # downloadingData(data_dir)

    batch_size = 400
    train_ds, valid_ds = preProcessingData(data_dir)
    ...
    # train_dls = DeviceDataLoader(train_ds, device)
